  ...
  const hospitalData = [
    {
      icon: locationIcon,
      title: "Location",
      value: "3rd Floor, OPD Tower, Vydehi Hospital, Whitefield",
    },
    {
      icon: hoursIcon,
      title: "Hours",
      value: "Monday–Saturday: 5:00 PM–7:00 PM",
    },
    {
      icon: contactIcon,
      title: "Contact",
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row gap-6 md:gap-16 bg-white px-6 py-8 sm:px-10 md:px-16 md:py-10 ">
        <div className="flex-1">
          ...
          {hospitalData.map(({ icon, title, value }, index) => (
          ...
          <div className="bg-[#EDF4F7] mt-10 px-6 py-6 rounded-lg">
            ...
            <p className="text-[#4A4A4A] text-base md:text-lg font-medium">
              Bengaluru residents seeking evening slots{" "}
            </p>
          </div>
        </div>
