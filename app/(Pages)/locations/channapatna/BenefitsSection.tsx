import { LocationIcon, NotificationIcon, ThunderIcon } from "@/app/Components/svgIcons/svgIcons";
  ...
  const benefits = [
    {
      ...
      title: "Faster Relief",
      description:
        "Same-day diagnosis with on-site digital X-ray at SAI Hospital means no extra trips or waiting.",
    },
    {
      icon: <LocationIcon/>,
      title: "Only Specialist Within 40 km",
      description:
        "Avoid the long waitlists in Bengaluru; get expert joint replacement care close to home.",
    },
    {
      icon: <NotificationIcon/>,
      title: "Patient-First Follow-Up",
      description:
        "Clear rehab roadmap and direct WhatsApp access to the doctor cut down treatment delays.",
    },
  ];
  ...
  return (
    <section className="max-w-7xl mx-auto py-12 px-6 sm:px-10 lg:px-16">
      <h2 className="text-black text-center font-poppins font-bold text-2xl sm:text-3xl md:text-4xl mb-12">
        Why Book at SAI Hospital Today?
      </h2>
