...
const HeroSection = () => {
  return (
    <section className="max-w-7xl flex flex-col items-center gap-6 mx-auto text-center px-6 md:pt-24 md:px-10 lg:px-24">
      <h1 className="text-[#1A4CA3] font-bold font-cormorant_garamond text-4xl md:text-5xl leading-tight">
      ...
      <button className="text-center pointer-events-none bg-[#1A4CA3]  py-3 px-5  rounded-lg hover:bg-[#1A4CA3]/90 transition-colors text-white text-xl font-medium">
